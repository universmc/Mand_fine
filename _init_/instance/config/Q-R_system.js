...
async function main() {
    groq.chat.completions.create({
        ...
        messages: [
            ...
            {
                role: "assistant",
                content: "messages system egal $content: DevOps"
            },
            // Set a user message for the assistant to respond to.
            {
                role: "system",
                content: "devOps, content > [messages] run brainstorming session + timestamp date ainsi que ça conversion en franaçs lang=FR"
            },
        ],
