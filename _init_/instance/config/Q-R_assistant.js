...
async function main() {
    groq.chat.completions.create({
        ...
        messages: [
            ...
            {
                role: "assistant",
                content: "comment est que je doit pour concevoir la gestion d'une base de donnée (backend) basé sur le model de gantt optimiser avec 'pi'et les technogie groq -L."
            },
            {
                role: "system",
